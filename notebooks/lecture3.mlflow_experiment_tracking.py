...
experiment = mlflow.set_experiment(experiment_name="/Shared/telco-demo")
mlflow.set_experiment_tags({"repository_name": "zohaibnajam/telco-churn"})
...
experiments = mlflow.search_experiments(
    filter_string="tags.repository_name='zohaibnajam/telco-churn'"
)
print(experiments)
...
run_id = mlflow.search_runs(
    experiment_names=["/Shared/telco-demo"],
...
mlflow.log_param("type", "telco_demo2")
...
mlflow.start_run(run_name="telco-demo-run-extra",
                 tags={"git_sha": "1234567890abcd"},
                       description="telco churn demo run with extra artifacts",)
